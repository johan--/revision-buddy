...
gulp.task('client:build', ['html', 'styles'], function () {
  ...
  return gulp.src(paths.views.main)
    .pipe(replace(/="bower_components\//g, '="/app/bower_components/'))
...
gulp.task('copy:font-components', function () {
    return gulp.src(yeoman.app + '/bower_components/components-font-awesome/fonts/**/*')
        .pipe(gulp.dest(yeoman.dist + '/fonts'));
});

gulp.task('build', ['clean:dist'], function () {
    runSequence(['images', 'copy:extras', 'copy:fonts', 'copy:font-components', 'copy:font-bootstrap', 'client:build']);
});
